...
use frontend\models\LabfuSearch;
...
/**
 * LabfuController implements the CRUD actions for Labfu model.
 */
class LabfuController extends Controller
{
    ...
    public function actionResult($pid,$seq){
      $last = Labfu::find()->labCompare($pid,$seq);
