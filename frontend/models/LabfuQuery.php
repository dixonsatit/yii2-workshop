...
use \Yii;
/**
 * This is the ActiveQuery class for [[Labfu]].
 *
 * @see Labfu
 */
class LabfuQuery extends \yii\db\ActiveQuery
{
    ...
    public function labCompare($pid,$seqSelect){
      if(($beforeRecrod = $this->selectLastRecord($pid,$seqSelect)) != null){
        ...
        SELECT
          ...
          LEFT JOIN(
          	SELECT
          		LABTEST as LABTEST_BEFORE,
          		LABRESULT AS LABRESULT_BEFORE
          	FROM
          		labfu
          	WHERE
          		SEQ = :SEQ_BEFORE
          )labfu_before ON labfu_before.LABTEST_BEFORE = labfu_select.LABTEST
        ",[
